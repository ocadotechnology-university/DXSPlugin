...
import { D as DefaultStarredEntitiesApi, r as rootRouteRef, v as viewTechDocRouteRef, c as createComponentRouteRef, b as createFromTemplateRouteRef, u as unregisterRedirectRouteRef } from './routes-6e97578f.esm.js';
...
import { u as useEntityFromUrl } from './useEntityFromUrl-59c4a128.esm.js';
...
const catalogPage = createPageExtension({
  ...
  loader: async ({ inputs }) => {
    const { BaseCatalogPage } = await import('./index-25ea000b.esm.js');
...
const catalogEntityPage = createPageExtension({
  ...
  loader: async ({ inputs }) => {
    const { EntityLayout } = await import('./index-ac18d30d.esm.js');
    const Component = () => {
      const { entity, ...rest } = useEntityFromUrl();
      return /* @__PURE__ */ React.createElement(AsyncEntityProvider, { entity, ...rest }, entity ? /* @__PURE__ */ React.createElement(EntityLayout, null, inputs.contents.filter(
        ({ output: { filterFunction, filterExpression } }) => buildFilterFn(filterFunction, filterExpression)(entity)
      ).map(({ output: { path, title, element } }) => /* @__PURE__ */ React.createElement(EntityLayout.Route, { key: path, path, title }, element))) : null);
    };
...
const catalogAboutEntityCard = createEntityCardExtension({
  name: "about",
  loader: async () => import('./index-fcc6ada1.esm.js').then(
...
const catalogLinksEntityCard = createEntityCardExtension({
  name: "links",
  filter: "has:links",
  loader: async () => import('./index-a2f43c63.esm.js').then(
...
const catalogLabelsEntityCard = createEntityCardExtension({
  name: "labels",
  filter: "has:labels",
  loader: async () => import('./index-1819df86.esm.js').then(
...
const catalogDependsOnComponentsEntityCard = createEntityCardExtension({
  ...
  loader: async () => import('./index-5d579387.esm.js').then(
...
const catalogDependsOnResourcesEntityCard = createEntityCardExtension({
  ...
  loader: async () => import('./index-2ae6a112.esm.js').then(
...
const catalogHasComponentsEntityCard = createEntityCardExtension({
  name: "has-components",
  loader: async () => import('./index-151a7b53.esm.js').then(
...
const catalogHasResourcesEntityCard = createEntityCardExtension({
  name: "has-resources",
  loader: async () => import('./index-457f1bef.esm.js').then(
...
const catalogHasSubcomponentsEntityCard = createEntityCardExtension({
  ...
  loader: async () => import('./index-df2397a2.esm.js').then(
...
const catalogHasSystemsEntityCard = createEntityCardExtension({
  name: "has-systems",
  loader: async () => import('./index-b87e664e.esm.js').then(
...
const catalogOverviewEntityContent = createEntityContentExtension({
  ...
  loader: async ({ inputs }) => import('./EntityOverviewPage-0844baf1.esm.js').then((m) => /* @__PURE__ */ React.createElement(m.EntityOverviewPage, { cards: inputs.cards.map((c) => c.output) }))
});
...
const catalogSearchResultListItem = createSearchResultListItemExtension({
  ...
  component: () => import('./index-a73e6d8d.esm.js').then(
...
//# sourceMappingURL=alpha-0a041adb.esm.js.map
