...
<<<<<<< HEAD
import { c as catalogGraphRouteRef, D as Direction, a as catalogEntityRouteRef } from './esm/routes-c6756725.esm.js';
...
=======
import { c as catalogGraphRouteRef, D as Direction, a as catalogEntityRouteRef } from './esm/routes-B7pnW8AZ.esm.js';
import '@backstage/catalog-model';
import '@backstage/core-components';
import '@backstage/core-plugin-api';
...
<<<<<<< HEAD
  loader: async ({ config: { filter, ...props } }) => import('./esm/index-4d97d76b.esm.js').then(
=======
  loader: async ({ config: { filter, ...props } }) => import('./esm/index-Dy8_Ufah.esm.js').then(
>>>>>>> master
...
<<<<<<< HEAD
  loader: ({ config: { path, ...props } }) => import('./esm/index-201fbff6.esm.js').then(
=======
