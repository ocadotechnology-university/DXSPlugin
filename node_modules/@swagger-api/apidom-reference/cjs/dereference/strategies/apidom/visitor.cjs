...
const ApiDOMDereferenceVisitor = (0, _stampit.default)({
  ...
  methods: {
    ...
    async RefElement(refElement, key, parent, path, ancestors) {
       ...
       */
      if ((0, _apidomCore.isObjectElement)(referencedElement) && (0, _apidomCore.isObjectElement)(ancestors[ancestors.length - 1])) {
        /**
      ...
      } else if ((0, _apidomCore.isArrayElement)(referencedElement) && Array.isArray(parent)) {
        /**
