...
declare class QueryUtil<AppModelType, DbModelType extends firestore.DocumentData, Template extends Query<AppModelType, DbModelType> | VectorQuery<AppModelType, DbModelType>> {
    ...
    _get(query: Template, transactionIdOrReadTime?: Uint8Array | Timestamp, retryWithCursor?: boolean): Promise<QuerySnapshot<AppModelType, DbModelType> | VectorQuerySnapshot<AppModelType, DbModelType>>;
    ...
    _stream(query: Template, transactionIdOrReadTime?: Uint8Array | Timestamp, retryWithCursor?: boolean, explainOptions?: firestore.ExplainOptions): NodeJS.ReadableStream;
}
>>>>>>> master
/**
