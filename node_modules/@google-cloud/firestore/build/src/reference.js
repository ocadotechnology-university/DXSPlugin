...
class QueryUtil {
    ...
    _get(query, transactionIdOrReadTime, retryWithCursor = true) {
        const docs = [];
        ...
        return new Promise((resolve, reject) => {
            ...
            this._stream(query, transactionIdOrReadTime, retryWithCursor)
                ...
                resolve(query._createSnapshot(readTime, docs.length, () => docs, () => {
                    const changes = [];
    ...
    _stream(query, transactionIdOrReadTime, retryWithCursor = true, explainOptions) {
        const tag = (0, util_1.requestTag)();
...
=======
        return this._queryUtil._get(this, transactionIdOrReadTime);
>>>>>>> master
    }
    /**
...
=======
    _stream(transactionIdOrReadTime, explainOptions) {
        return this._queryUtil._stream(this, transactionIdOrReadTime, true, explainOptions);
>>>>>>> master
    }
    /**
...
class VectorQuery {
     ...
     */
    get() {
        return this._queryUtil._get(this, 
